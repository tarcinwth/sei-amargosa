...
function initNaoVisualizadoPro() {
    $('.processoNaoVisualizado').each(function(){
        ...
        $(this).closest('tr').addClass('home-highlight home-unread');
    });
}
function initUrgentePro() {
    ...
    $('a[href*="controlador.php?acao=procedimento_trabalhar"][onmouseover*="(URGENTE)"]')
        ...
        .addClass('urgentePro')
        .closest('tr')
        .addClass('home-highlight home-urgent');
}
...
function initSeiPro() {
	if ( $('#tblProcessosRecebidos, #tblProcessosGerados, #tblProcessosDetalhado').length > 0 ) {
        ...
        if (typeof URL_SPRO !== 'undefined' && typeof moment !== 'undefined' && typeof moment.duration === 'function' && typeof moment.duration().format === 'undefined') {
